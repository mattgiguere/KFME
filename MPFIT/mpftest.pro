...
;  degrees of freedom in the "original" fit, DOF1 (DOF2 < DOF2); and
;  also CHI2 < CHI1.
;
...
;   reduction of the chi-squared value by 7.7.
;
; REFERENCES:
;
...
;     Nov 2001, CM
;
;  $Id: mpftest.pro,v 1.3 2001/11/18 12:59:16 craigm Exp $
;-
