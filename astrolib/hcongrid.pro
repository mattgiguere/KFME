...
;               (default), 2 for cubic interpolation.   
...
;- 
 ...
 if Npar EQ 0  then begin 
     ...
     print,'                       CUBIC = , INTERP =, /HALF, OUTSIZE = ]'
     return
 endif
...
; Update astrometry info if it exists
 ...
 if keyword_set(half_half) then begin
     ...
     sxaddpar, newhd, 'CRPIX1', crpix[0]*xratio + 1.0, FORMAT='(E14.7)'
     sxaddpar, newhd, 'CRPIX2', crpix[1]*yratio + 1.0, FORMAT='(E14.7)'
 endelse 
